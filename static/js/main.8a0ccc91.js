...
`,uS=ki`
  ...
  --header-font: 'Poppins', sans-serif;
  --body-font: 'Roboto', sans-serif;
  --card-shadow: 0 6px 20px rgba(230, 0, 18, 0.15);
  --button-gradient: linear-gradient(135deg, #e60012, #ff5a5f);
  --background-image: url('/nintendo-bg.svg'), radial-gradient(circle, #f0f8ff 0%, #ffe8e8 100%);
`,dS=ki`
